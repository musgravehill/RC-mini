...
uint32_t timeCollect_micros = 0L;
int32_t angleCollect = 0L;
int servoAngle = 0;
...
void loop()
{
  ...
  if ((currMicros - timeCollect_micros) > 1000000) {   
    //Serial.println(angleCollect);
    int servoAngle =  map(angleCollect, -222000, 222000, 0, 170);  //servo +_ 60 degree
   //Serial.println(servoAngle);    

    timeCollect_micros = currMicros;
    angleCollect = 0L;
  } else {
    angleCollect += zRate;
  }
